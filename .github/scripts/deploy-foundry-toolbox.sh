...
ARM_CONNECTION_URL="$(foundry_arm_connection_url "$SUBSCRIPTION_ID" "$AZURE_RESOURCE_GROUP" "$FOUNDRY_ACCOUNT_NAME" "$FOUNDRY_PROJECT_NAME" "$FOUNDRY_TOOLBOX_CONNECTION_NAME")"
