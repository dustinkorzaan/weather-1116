...
public class GetCurrentAIWeatherV3HandlerTests
{
    ...
    {
        var prompt = File.ReadAllText(RepoFiles.FindRepoFile("core-dotnet/core/AIWeather/Handlers/GetCurrentAIWeatherV3Handler.cs"));
    ...
    public void Handler_UsesInProcessToolLoopNotRemoteMcp()
    {
        ...
        Assert.Contains("Tools = { getLatLongTool, getLocationTool, getCitiesTool, getPublicWeatherCurrentTool, getPublicWeatherForecastTool, getPublicWeatherHistoryTool, getUserTool, addUserCityTool, deleteUserCityTool }", source, StringComparison.Ordinal);
