...
{
    [Fact]
    public void HydrateRuntimes_FirstEntry_HasZeroRuntimes()
    {
        ...
        var entries = recorder.HydrateRuntimes();
    ...
    [Fact]
    public void HydrateRuntimes_SameLoop_AccumulatesLoopRuntimeFromLoopStart()
    {
        var clock = new FakeTimeProvider(new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc));
        var recorder = new AIRunLogRecorder(clock);
    ...
    [Fact]
    public void HydrateRuntimes_NewLoop_ResetsLoopRuntimeButNotRunningTotal()
    {
        var clock = new FakeTimeProvider(new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc));
        var recorder = new AIRunLogRecorder(clock);
    ...
    [Fact]
    public void HydrateRuntimes_RevisitedLoopNumber_AnchorsToFirstOccurrence()
    {
        var clock = new FakeTimeProvider(new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc));
        var recorder = new AIRunLogRecorder(clock);
