...
/**
 * V3 tab: in-process tool loop (Responses API, like Foundry Console V3). Copied
 * (not shared) from the V4/V5 tabs — this repo duplicates each AI weather variant
 * rather than parameterizing one generic component.
 */
function CurrentAIWeatherV3Tab() {
...
export default CurrentAIWeatherV3Tab;
