...
const TAB_CONFIG = [
  ...
  },
  {
    ...
    label: 'Chat5a',
    shortLabel: '5a',
    description: 'Agent Framework · Local Loops · Multi-agent · Guardrailed (5 toggleable gates below)',
  ...
  },
  {
    ...
    label: 'Chat5b',
    shortLabel: '5b',
    description: 'Agent Framework · Remote MCP · Multi-agent · Guardrailed (5 toggleable gates below)',
