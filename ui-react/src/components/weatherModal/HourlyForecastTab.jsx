...
import { degreesToCompass, formatClockTime, formatPrecipitationIn } from '../../utils/weatherGridFormat';

/** Static single-use grid for the Hourly Forecast tab — soonest first. */
function HourlyForecastTab({ lat, lng }) {
  ...
  return (
    <section aria-labelledby="hourly-forecast-heading">
      ...
      {isError && <p className="text-destructive">Unable to load hourly forecast.</p>}
