...
var containerAppsConfig = [
  { key: 'api', setAzureClientId: true, minReplicas: 1, maxReplicas: 3, stickySessions: false }
  { key: 'mvc', setAzureClientId: true, minReplicas: 1, maxReplicas: 3, stickySessions: false }
  ...
  { key: 'mcp-srv-app-service', setAzureClientId: false, minReplicas: 1, maxReplicas: 2, stickySessions: false }
]
