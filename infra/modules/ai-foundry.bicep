...
var geoNonAiWeatherToolboxName = 'wx1116-geo-nonaiweather-toolbox'
var toolboxConsumerUrl = 'https://${customSubDomainName}.services.ai.azure.com/api/projects/${projectName}/toolboxes/${geoNonAiWeatherToolboxName}/mcp?api-version=v1'
...
resource mcpSrvPythonConnection 'Microsoft.CognitiveServices/accounts/projects/connections@2025-04-01-preview' = {
  parent: foundryProject
  name: 'MyMcpSrvPython'
  properties: {
    category: 'RemoteTool'
    target: mcpSrvPythonUrl
    authType: 'CustomKeys'
    isSharedToAll: true
    credentials: {
      keys: {
