...
/// this does not resolve the tool list or check MCP_SRV_APP_SERVICE_KEY, so callers that only
/// need "is this container up" (ui-react's wake screen) don't pay for that on every retry.
/// </summary>
[ApiController]
[Route("[controller]")]
[AllowAnonymous]
