...
6. **Live Demos**
   - Live links: [React UI](https://wx.korzaan.com), [Blazor UI](https://wx1116-prod-blazor.azurewebsites.net), [MVC UI](https://wx1116-prod-mvc.azurewebsites.net)
   - Current AI Weather links: [React UI](https://wx.korzaan.com/current-ai-weather), [Blazor UI](https://wx1116-prod-blazor.azurewebsites.net/current-ai-weather), [MVC UI](https://wx1116-prod-mvc.azurewebsites.net/current-ai-weather)
   - Chat links: [React UI](https://wx.korzaan.com/chat-clients), [Blazor UI](https://wx1116-prod-blazor.azurewebsites.net/chat-clients), [MVC UI](https://wx1116-prod-mvc.azurewebsites.net/chat-clients)
