...
4. **V4** — model-direct with remote MCP tools; same loop, tools run on MCP hosts.
5. **V5** — hosted Foundry agent demo; agent owns the instructions, response schema, and MCP tools; console sends only the user prompt.
