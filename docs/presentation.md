...
6. **Live Demos**
   - Live links: [React UI](https://wx.korzaan.com), [Blazor UI](https://wx1116-prod-blazor.thankfulrock-0d49c0fe.centralus.azurecontainerapps.io), [MVC UI](https://wx1116-prod-mvc.thankfulrock-0d49c0fe.centralus.azurecontainerapps.io)
   - Current AI Weather links: [React UI](https://wx.korzaan.com/current-ai-weather), [Blazor UI](https://wx1116-prod-blazor.thankfulrock-0d49c0fe.centralus.azurecontainerapps.io/current-ai-weather), [MVC UI](https://wx1116-prod-mvc.thankfulrock-0d49c0fe.centralus.azurecontainerapps.io/current-ai-weather)
   - Chat links: [React UI](https://wx.korzaan.com/chat-clients), [Blazor UI](https://wx1116-prod-blazor.thankfulrock-0d49c0fe.centralus.azurecontainerapps.io/chat-clients), [MVC UI](https://wx1116-prod-mvc.thankfulrock-0d49c0fe.centralus.azurecontainerapps.io/chat-clients)
