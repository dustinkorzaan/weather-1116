...
- Designed and engineered an integrated, data-driven full-stack platform using React, .NET API, C#, MSSQL, Foundry, and Azure Cloud services (App Services, Blob Storage, Service Bus, Event Grid), PING, OAuth, JWT.
