...
| `AZURE_FOUNDRY_PROD_EUS2_CHAT_AGENT_NAME` | Chat3 only (optional; defaults to `wx1116-agent-chat`). GitHub var / App Service. Independent of V5's `AZURE_FOUNDRY_PROD_EUS2_AGENT_NAME`. |
...
3. **Name:** must match `AZURE_FOUNDRY_PROD_EUS2_CHAT_AGENT_NAME` (defaults to `wx1116-agent-chat`).
