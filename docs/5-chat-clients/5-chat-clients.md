...
| `AZURE_FOUNDRY_PROD_CHAT_AGENT_NAME` | Chat3 only (required). GitHub var / App Service. Independent of V5's `AZURE_FOUNDRY_PROD_AGENT_NAME`. |
...
`AZURE_FOUNDRY_PROD_AGENT_NAME` remains the V5 console agent (`wx1116-agent-for-current-weather`,
