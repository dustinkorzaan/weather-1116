...
Standalone Node.js MCP server exposing three public weather tools, backed directly by the
[Open-Meteo](https://open-meteo.com/) API:

- `GetPublicWeatherCurrent` — current conditions (Open-Meteo `current_weather`)
